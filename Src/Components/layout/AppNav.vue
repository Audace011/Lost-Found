          ...
          <div class="nav__pill-wrap" ref="userRef">
            ...
            <Transition name="slide-up">
              <div v-if="userOpen" class="nav__drop">
                ...
                <button v-if="!auth.isAdmin" class="nav__drop-item" @click="contactAdmin">
    ...
    <Transition name="slide-up">
      <div v-if="mobileOpen" class="nav__mobile">
        ...
        <template v-if="auth.isLoggedIn">
          ...
          <button v-if="!auth.isAdmin" class="nav__mob-item" @click="contactAdmin">Contact Support</button>
...
function contactAdmin() {
  userOpen.value = false; mobileOpen.value = false;
  const adminId = 'u-admin';
  const myId = auth.user.id;
  const key = `${[myId, adminId].sort().join('-')}_admin-contact`;
